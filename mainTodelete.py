...
def onerun(slide=100, window=200,slidingWindow=None,keepmax=(10,0.5),debug=False,features=False,normalize=False,dataset="./data/YAHOO/Yahoo_A2synthetic_",dynrun=True):
    dynallf1 = []
    statallf1 = []
    counter = 0
...
if __name__ == "__main__" :
    ...
    lista=[
        {'k': 30, 'r': 0.01, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
         'normalize': False} ,
    {'k': 30, 'r': 0.1, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 30, 'r': 2.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 30, 'r': 5.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 30, 'r': 0.5, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 30, 'r': 10.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 40, 'r': 0.01, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 40, 'r': 0.1, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 30, 'r': 1.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 40, 'r': 2.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 40, 'r': 0.5, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 40, 'r': 1.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 40, 'r': 5.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False} ,
    {'k': 40, 'r': 10.0, 'window': 400, 'shift': 200, 'initSubseq': 10.0, 'features': False,
     'normalize': False}
    ...
    datasets=["./data/YAHOO/Yahoo_A1real_","./data/YAHOO/Yahoo_A2synthetic_","./data/YAHOO/YahooA3Benchmark-TS","./data/YAHOO/YahooA4Benchmark-TS"]
    for comb in lista:
        for dataset in datasets:
            onerun(slide=comb['shift'], window=comb['window'],slidingWindow=comb['initSubseq'],keepmax=(comb['k'],comb['r']),
               debug=False,features=int(comb['features']),normalize=comb['normalize'],dataset=dataset,dynrun=False)
